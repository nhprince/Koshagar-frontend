    ...
    <div className="flex flex-col h-full">
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xl font-bold tracking-tight leading-none">Shared Links</h1>
            <p className="text-xs text-muted-foreground mt-0.5">Files with active public links</p>
          </div>
        </div>
      ...
      {isLoading ? (
        ...
        <EmptyState
          ...
          description="Share a file or folder to create a public link. Your shared items will appear here."
        />
      ) : (
        <div className="pb-16">
